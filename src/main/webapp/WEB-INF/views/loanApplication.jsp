...
<div class="alert alert-secondary" role="alert">
      <form:form method="post" modelAttribute="account" action="loanSubmit?accId=${account.accountId}&&userId=${user.userId}">
...
<div class="form-group row">
<form:label for="inputEmail3" class="col-sm-2 col-form-label" path="amt_req"><b><i>Loan Req:</i></b></form:label>
<div class="col-sm-10">
<form:input type="text" class="form-control" id="inputEmail3" placeholder="Enter Amount" path="amt_req" />
</div>
</div>
